...
zenClass MixinMinecraftHelpers {
  ...
  function isClientSide() as bool {
    if (!scripts.mods.mixins.cyclopscore.shared.Op.isModdedComputed) {
      scripts.mods.mixins.cyclopscore.shared.Op.isModdedComputed = true;
      scripts.mods.mixins.cyclopscore.shared.Op.isModdedCached = MinecraftHelpers.isModdedEnvironment();
    }
    if (scripts.mods.mixins.cyclopscore.shared.Op.isModdedCached) {
