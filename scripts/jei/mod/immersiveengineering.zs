#modloaded immersiveengineering requious
#priority 950
...
// -----------------------------------------------------------------------
// Garden Cloche - which fluids work as liquid fertilizer and their multiplier.
// Recipe data registered separately in scripts/mods/roidtweaker.zs (the actual
// RoidTweaker.GardenCloche.addFertilizer calls); this just builds the JEI tab.
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// Chemical Thrower - what it can spray to create blocks
// -----------------------------------------------------------------------
